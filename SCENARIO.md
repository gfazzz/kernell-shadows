...
- Physical threat: Крылов пытается проникнуть в московский ЦОД

**Команда (распределённая по миру):**
- **Макс** (Исландия) — координация инфраструктуры, command center
- **Алекс** (Москва) — offensive security, контратака на серверы Крылова
- **Анна** (Цюрих) — defensive security, forensics, защита финансовых данных
- **Дмитрий** (Берлин) — автоматизация, scaling, CI/CD под огнём
