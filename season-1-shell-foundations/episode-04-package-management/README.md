...
**Дата:** 5 октября 2025, 11:30
**Локация:** Москва, ЦОД "Москва-1", серверная комната
**Участники:** Max Sokolov (вы), Viktor Petrov, LILITH

После успешного анализа логов атаки (Episode 03), Viktor вызывает вас в серверную.

**Viktor Petrov:**
> *"Max, хорошая работа с логами. Ты нашёл Tor exit node за 4 часа. Anna впечатлена."*

Он кладёт на стол флешку.
...
**Viktor:**
> *"Поэтому ты автоматизируешь. Скрипт. Один запуск — всё установлено. Без ошибок. Без конфликтов."*

**LILITH (через терминал):**
> *"Ah, package management. Где 'dependency hell' встречается с 'it worked on my machine'. Готовься к боли, Max."*

**Viktor:**
> *"У тебя 6 часов. Начни с тестового сервера. Когда скрипт будет готов — я дам доступ к остальным. Не подведи."*

Он уходит. Вы остаётесь с флешкой и списком инструментов.
...
> *"Погнали. У тебя 6 часов до того, как Viktor начнёт задавать неудобные вопросы."*
...
## 🎬 CLIFFHANGER: Что дальше?

Viktor читает ваш отчёт. Все 15 пакетов установлены на тестовом сервере.

**Viktor:**
> *"Отлично. Завтра запускаешь на всех 50 серверах. Но сначала..."*

Он открывает терминал и показывает вам netstat вывод:
...
**Вы:**
> *"Открытые порты. SSH, HTTP, MySQL, что-то на 8080..."*

**Viktor:**
> *"8080 не должен быть открыт. Найди, что это. Закрой. У тебя до конца дня."*

**LILITH:**
> *"Welcome to networking, Max. Следующий эпизод: TCP/IP, ports, firewalls. Тени становятся глубже."*

**→ Season 2, Episode 05: TCP/IP Fundamentals**
...
**KERNEL SHADOWS — Episode 04**

*"Dependencies как семья. Не выбираешь их, но приходится с ними жить."* — LILITH

**[Season 1 README](../README.md)** • **[Next Episode →](../episode-05-tcp-ip-fundamentals/)**
