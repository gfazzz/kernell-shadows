...
## 📅 02 октября 2025, 14:17 — ГУМ, Москва

Viktor Petrov сидит у окна. Седые волосы, черный костюм, проницательный взгляд. Он жестом приглашает вас сесть.

> **Viktor:**
> *"Максим Соколов. 28 лет. Системный администратор. 5 лет в ЦОД 'Сибирь-Телеком'."*

Он знает о вас. Много.

> **Viktor:**
> *"У меня проект. 50 серверов. Военные стандарты безопасности. $50,000 за месяц работы."*

Пауза. Он поворачивает ноутбук к вам.

> **Viktor:**
> *"Тестовое задание. На сервере спрятаны файлы с координатами других серверов. Найди их. 24 часа."*

Он передает листок:

```
SSH: 185.192.45.118 (симуляция: artifacts/test_environment)
User: max_test
Mission: Найти 3 скрытых файла
```

> **Viktor:**
> *"Справишься — встретимся завтра. Здесь же. 14:00."*

Он оставляет конверт на столе. $2,000. И уходит.

**К черту поезд обратно в Новосибирск.**

---

## 18:00 — Хостел "Красный Октябрь"

Ноутбук на коленях. Терминал открыт. Время начинать.
...
│   Я буду наблюдать. Помогу только если докажешь,             │
│   что способен думать.                                        │
│                                                               │
