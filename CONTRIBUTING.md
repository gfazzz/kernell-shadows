...
```
episode-XX-название/
├── mission.md          # Сюжетное задание (300-500 строк)
├── README.md           # Теория (500-1000 строк)
...
**Структура:**
1. Заголовок с метаданными (сезон, эпизод, сложность, время)
2. Сюжетная завязка (диалоги персонажей)
3. Цель миссии
4. Пошаговая инструкция
5. Критерии успеха
6. Подсказки от LILITH
7. Что дальше

**Стиль:**
- Драматический (как в триллере)
- Диалоги естественные
- Deadline и напряжение
- Cliffhanger в конце
...
**Структура:**
1. Введение в тему
2. Теоретические блоки (по 100-200 строк)
3. LILITH комментарии после каждого блока
4. Примеры кода с объяснениями
5. Контрольные вопросы (5-10)
...
**Alex Sokolov:**
- Брат Max, ex-FSB, grey hat hacker
- Ментор по security
- Защищает Max, но втягивает в опасность

**Anna Kovaleva, Dmitry Orlov, Eva Zimmerman:**
