...
Это **продолжение вселенной [OPERATION MOONLIGHT](../moonlight-course/)**, но фокус смещён с низкоуровневого программирования на C к Linux системам, сетям, безопасности и инфраструктуре.
...
- (Опционально) Прохождение [OPERATION MOONLIGHT](../moonlight-course/) для полного погружения в сюжет
...
- **[OPERATION MOONLIGHT](../moonlight-course/)** — курс программирования на C (та же вселенная)
